                ...
                .EnableSwagger(c =>
                    {
                        ...
                        c.SingleApiVersion("v1", "Inventario WebApi")
                        .Description("Una Web API diseñada para el sistema de inventario de una empresa privada")
                        .TermsOfService("Términos de servicio.")
                        .Contact(x => x
                            .Name("Miguel Arturo Jimenez May")
                            .Url("https://www.linkedin.com/mwlite/in/miguel-arturo-jimenez-may-a9226415a")
                            .Email("miguel_jimenez_may@hotmail.com"))
                        .License(x => x
                            .Name("Licencia")
                            .Url("https://www.linkedin.com/mwlite/in/miguel-arturo-jimenez-may-a9226415a"));
